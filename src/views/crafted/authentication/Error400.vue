      ...
      <div class="d-flex flex-column flex-center text-center p-10">
        ...
        <div class="card card-flush w-lg-650px py-5">
          <div class="card-body py-15 py-lg-20">
            <!--begin::Title-->
            <h1 class="fw-bolder fs-2hx text-gray-900 mb-4">อ่าฮ่าาาาาาาา!</h1>
            <!--end::Title-->
            <!--begin::Text-->
            <div class="fw-semibold fs-6 text-gray-500 mb-7">
              เข้าไม่ได้อะดิ 555555555555.
            </div>
            <!--end::Text-->
            <!--begin::Illustration-->
            <div class="mb-3">
              <img
                :src="getAssetPath('media/auth/400-error-meme.jpg')"
